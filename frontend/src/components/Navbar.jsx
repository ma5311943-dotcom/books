    ...
    <>
      <nav
        className={`${navbarStyles.nav(
          scrolled
        )} ml-1 mr-5 md:ml-0 sm:ml-0 md:mr-0 sm:mr-0`}
      >
            ...
            <Link to="/" className={navbarStyles.logoContainer}>
              <div className="relative group">
                ...
                <div className="flex relative items-center">
                  <img className={navbarStyles.logoImage} src={logo} />
                  <div className="ml-1">
              ...
              <div className="flex flex-col space-y-1">
                ...
                <div className={navbarStyles.mobileIconRow}>
                  <Link
                    ...
                    onClick={() => setIsOpen(false)}
                  >
                    <FaOpencart className="w-5 h-5 text-gray-600 group-hover:text-amber-600" />
                    {totalQuantity > 0 && (
