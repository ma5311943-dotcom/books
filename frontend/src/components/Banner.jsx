...
import { ScrollText, SearchIcon } from "lucide-react";
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="space-y-4 md:space-y-6">
              ...
              <p className={paragraphText}>
                Curated knowlege journeys that challenge perceptons and inspire
              ...
              <div className={formContainer}>
                <div className={inputWrapper}>
                  ...
                  <div className="relative flex items-center">
                    <SearchIcon className="ml-4 md:ml-5 w-5 h-5 md:w-6 md:h-6 text-gray-600 group-focus:within:text-[#2b5876]" />
                    <input
                      type="text"
                      value={searchQuery}
